...
void add_zh_cn() {
    ...
    ZH_CN_Loc["Runtime Information (NONE)"] = _S("运行时信息 (无)");
    ZH_CN_Loc["Log Level"] = _S("日志等级");
    ZH_CN_Loc["Enable Depth-based Latency Reduction"] = _S("启用基于深度降低延迟");
    ZH_CN_Loc["Controller Pitch Offset"] = _S("控制器间距偏移");
    ZH_CN_Loc["Left-handed Controller Inputs"] = _S("左控制器输入");
    ZH_CN_Loc["Freeze Position"] = _S("冻结位置");
    ZH_CN_Loc["Freeze Rotation"] = _S("冻结旋转");
    ZH_CN_Loc["Recenter Horizon Key"] = _S("重置地面中心快捷键");
    ZH_CN_Loc["Toggle In-Game UI Key"] = _S("切换游戏界面快捷键");
    ZH_CN_Loc["AHUD UI Compatibility"] = _S("AHUD UI兼容性");
    ZH_CN_Loc["Vertical Projection"] = _S("垂直投影");
    ZH_CN_Loc["Horizontal Projection"] = _S("水平投影");
    ZH_CN_Loc["Scale Render Target"] = _S("缩放渲染目标");
    ZH_CN_Loc["Show FPS"] = _S("显示帧率");
    ZH_CN_Loc["Show Engine Statistics"] = _S("显示引擎统计信息");
    ZH_CN_Loc["Attach Lerp Speed"] = _S("附加Lerp速度");
    ZH_CN_Loc["UObjectHook Keybinds"] = _S("UObjectHook按键绑定");
    ZH_CN_Loc["Disable UObjectHook Key"] = _S("禁用UObjectHook快捷键");
    ZH_CN_Loc["Constructor calls: %llu"] = _S("构造函数调用: %llu");
    ZH_CN_Loc["Destructor calls: %llu"] = _S("析构函数调用: %llu");
    ZH_CN_Loc["Native Stereo"] = _S("原生立体");
    ZH_CN_Loc["Synchronized Sequential"] = _S("同步序列");
    ZH_CN_Loc["Alternating/AFR"] = _S("交替帧渲染/AFR");
    ZH_CN_Loc["Skip Tick"] = _S("跳过下一刻");
    ZH_CN_Loc["Skip Draw"] = _S("跳过绘制");
    ZH_CN_Loc["Game"] = _S("游戏");
    ZH_CN_Loc["Head/HMD"] = _S("头部/头显");
    ZH_CN_Loc["Right Controller"] = _S("右控制器");
    ZH_CN_Loc["Left Controller"] = _S("左控制器");
    ZH_CN_Loc["Two Handed (Right)"] = _S("双手 (右)");
    ZH_CN_Loc["Two Handed (Left)"] = _S("双手 (左)");
    ZH_CN_Loc["Left Joystick (Disables Standard Joystick Input)"] = _S("Left Joystick (禁用标准摇杆输入)");
    ZH_CN_Loc["Right Joystick (Disables Standard Joystick Input)"] = _S("Right Joystick (禁用标准摇杆输入)");
    ZH_CN_Loc["Gesture (Head) + Left Joystick"] = _S("手势 (头部) + 左摇杆");
    ZH_CN_Loc["Gesture (Head) + Right Joystick"] = _S("手势 (头部) + 右摇杆");
    ZH_CN_Loc["Raw / default"] = _S("原始 / 默认");
    ZH_CN_Loc["Symmetrical"] = _S("对称");
    ZH_CN_Loc["Mirrored"] = _S("镜像");
    ZH_CN_Loc["Matched"] = _S("匹配");
    ZH_CN_Loc["Default Dark"] = _S("默认暗色");
    ZH_CN_Loc["Alternative Dark"] = _S("另类暗色");
    ZH_CN_Loc["Default Light"] = _S("默认明亮");
    ZH_CN_Loc["High Contrast"] = _S("高对比度");
    ZH_CN_Loc["Early"] = _S("早");
    ZH_CN_Loc["Late"] = _S("晚");
    ZH_CN_Loc["Very Late"] = _S("非常晚");
}
...
void add_cht() {
    ...
    CHT_Loc["Runtime Information (NONE)"] = _S("運行時信息 (無)");
    CHT_Loc["Log Level"] = _S("日誌等級");
    CHT_Loc["Enable Depth-based Latency Reduction"] = _S("啟用基於深度降低延遲");
    CHT_Loc["Controller Pitch Offset"] = _S("控製器間距偏移");
    CHT_Loc["Left-handed Controller Inputs"] = _S("左控製器輸入");
    CHT_Loc["Freeze Position"] = _S("凍結位置");
    CHT_Loc["Freeze Rotation"] = _S("凍結旋轉");
    CHT_Loc["Recenter Horizon Key"] = _S("重置地面中心快捷鍵");
    CHT_Loc["Toggle In-Game UI Key"] = _S("切換遊戲界面快捷鍵");
    CHT_Loc["AHUD UI Compatibility"] = _S("AHUD UI兼容性");
    CHT_Loc["Vertical Projection"] = _S("垂直投影");
    CHT_Loc["Horizontal Projection"] = _S("水平投影");
    CHT_Loc["Scale Render Target"] = _S("縮放渲染目標");
    CHT_Loc["Show FPS"] = _S("顯示幀率");
    CHT_Loc["Show Engine Statistics"] = _S("顯示引擎統計信息");
    CHT_Loc["Attach Lerp Speed"] = _S("附加Lerp速度");
    CHT_Loc["UObjectHook Keybinds"] = _S("UObjectHook按鍵綁定");
    CHT_Loc["Disable UObjectHook Key"] = _S("禁用UObjectHook快捷鍵");
    CHT_Loc["Constructor calls: %llu"] = _S("構造函數調用: %llu");
    CHT_Loc["Destructor calls: %llu"] = _S("析構函數調用: %llu");
    CHT_Loc["Native Stereo"] = _S("原生立體");
    CHT_Loc["Synchronized Sequential"] = _S("同步序列");
    CHT_Loc["Alternating/AFR"] = _S("交替幀渲染/AFR");
    CHT_Loc["Skip Tick"] = _S("跳過下一刻");
    CHT_Loc["Skip Draw"] = _S("跳過繪製");
    CHT_Loc["Game"] = _S("遊戲");
    CHT_Loc["Head/HMD"] = _S("頭部/頭顯");
    CHT_Loc["Right Controller"] = _S("右控製器");
    CHT_Loc["Left Controller"] = _S("左控製器");
    CHT_Loc["Two Handed (Right)"] = _S("雙手 (右)");
    CHT_Loc["Two Handed (Left)"] = _S("雙手 (左)");
    CHT_Loc["Left Joystick (Disables Standard Joystick Input)"] = _S("Left Joystick (禁用標準搖桿輸入)");
    CHT_Loc["Right Joystick (Disables Standard Joystick Input)"] = _S("Right Joystick (禁用標準搖桿輸入)");
    CHT_Loc["Gesture (Head) + Left Joystick"] = _S("手勢 (頭部) + 左搖桿");
    CHT_Loc["Gesture (Head) + Right Joystick"] = _S("手勢 (頭部) + 右搖桿");
    CHT_Loc["Raw / default"] = _S("原始 / 默認");
    CHT_Loc["Symmetrical"] = _S("對稱");
    CHT_Loc["Mirrored"] = _S("鏡像");
    CHT_Loc["Matched"] = _S("匹配");
    CHT_Loc["Default Dark"] = _S("默認暗色");
    CHT_Loc["Alternative Dark"] = _S("另類暗色");
    CHT_Loc["Default Light"] = _S("默認明亮");
    CHT_Loc["High Contrast"] = _S("高對比度");
    CHT_Loc["Early"] = _S("早");
    CHT_Loc["Late"] = _S("晚");
    CHT_Loc["Very Late"] = _S("非常晚");
}
